...
- [x] **Step 1: Write failing tests for stable course and lesson identities**
...
- [x] **Step 2: Run the identity tests and verify the missing-type failure**

Run: `swift test --filter CourseIdentityTests`

Expected: FAIL at compile time with `cannot find 'LessonKey' in scope`.

- [x] **Step 3: Implement only the stable identity wrappers**
...
- [x] **Step 4: Run the identity tests until they pass**

Run: `swift test --filter CourseIdentityTests`

Expected: 2 tests PASS.

- [x] **Step 5: Write the failing catalog metadata tests**
...
- [x] **Step 6: Run the catalog tests and verify only catalog symbols are missing**
...
- [x] **Step 7: Implement immutable course-definition types**
...
- [x] **Step 8: Implement `CourseCatalog.default` with the exact tested constants**
...
- [x] **Step 9: Run identity, catalog, and full tests**
...
- [x] **Step 10: Commit the course identity boundary**
...
- [x] **Step 1: Write failing tests for explicit key/value pairing and availability errors**
...
- [x] **Step 2: Run and confirm the missing provider types fail compilation**
...
- [x] **Step 3: Implement the module, provider protocol, and error contracts**
...
- [x] **Step 4: Implement `LegacySwiftCourseProvider`**
...
- [x] **Step 5: Implement `CourseContentRegistry`**
...
- [x] **Step 1: Write the complete resolver decision-table tests**
...
- [x] **Step 2: Run the resolver tests and verify the missing symbol failure**

Run: `swift test --filter CourseDestinationResolverTests`

Expected: FAIL with missing `CourseDestinationResolver`.

- [x] **Step 3: Implement one pure resolver with no store or UI dependency**
...
- [x] **Step 4: Run the complete resolver tests**

Run: `swift test --filter CourseDestinationResolverTests`

Expected: all decision-table tests PASS.

- [x] **Step 5: Commit the destination policy**
...
- [x] **Step 1: Write failing identity, stage-event, and presentation-state tests**
...
- [x] **Step 2: Run and confirm the evidence identities are missing**

Run: `swift test --filter ProgressDocumentTests`

Expected: FAIL at compile time for missing `ProgressEventID`.

- [x] **Step 3: Implement only evidence ID wrappers, stage events, and presentation state**
...
- [x] **Step 4: Run the first progress-model tests until they pass**

Run: `swift test --filter ProgressDocumentTests`

Expected: the identity, stage-event, and presentation-state tests PASS.

- [x] **Step 5: Add failing attempt, review, readiness, and document round-trip tests**
...
- [x] **Step 6: Run and verify only the higher-level DTOs are missing**
...
- [x] **Step 7: Implement objective mappings, attempt enums, and `AssessmentAttempt`**
...
- [x] **Step 8: Implement `ReviewRecord` and `ReadinessSnapshot`**
...
- [x] **Step 9: Implement `CourseProgressDocument` and `ProgressDocument`**
...
- [x] **Step 10: Run the higher-level DTO round-trip test**
...
- [x] **Step 11: Write and run the failing course-key object test**
...
- [x] **Step 12: Implement object-key coding for `ProgressDocument.courses`**
...
- [x] **Step 13: Run the course-key wire-shape test**

Run: `swift test --filter ProgressDocumentTests/testVersionThreeUsesObjectCourseKeys`

Expected: PASS and `courses` is a JSON object.

- [x] **Step 14: Write and run the failing presentation-state key test**
...
- [x] **Step 15: Implement object-key coding for presentation states**
...
- [x] **Step 16: Run presentation-key and invalid-key tests**
...
- [x] **Step 17: Write and run a failing exact fractional timestamp test**
...
- [x] **Step 18: Implement the symmetric v3 date strategy**
...
- [x] **Step 19: Add the literal v3 fixture and run all progress-model tests**
...
- [x] **Step 20: Run the diff check**

Run: `git diff --check`

Expected: no output and exit status 0.

- [x] **Step 21: Commit the progress document contracts**
...
- [x] **Step 1: Add a literal version 2 fixture and fixture loader**
...
- [x] **Step 2: Write a failing version 1 migration test**
...
- [x] **Step 3: Run the v1 test and verify the migrator is missing**
...
- [x] **Step 4: Implement the version envelope, result enum, and v1 branch**
...
- [x] **Step 5: Run the v1 migration test until it passes**

Run: `swift test --filter ProgressMigrationTests/testVersionOneMigratesToSwiftCourse`

Expected: PASS.

- [x] **Step 6: Write and run a failing lossy v2 element-decoder test**
...
- [x] **Step 7: Implement only `LegacyStageEvent` and lossy element decoding**
...
- [x] **Step 8: Run the lossy element-decoder test**

Run: `swift test --filter ProgressMigrationTests/testLossyVersionTwoElementDecoding`

Expected: PASS.

- [x] **Step 9: Write and run a failing legacy metadata-validator test**
...
- [x] **Step 10: Implement only legacy metadata validation**

Port the current `ProgressStore.hasValidMetadata` switch without adding
deduplication or mapping.

- [x] **Step 11: Run the metadata-validator test**

Run: `swift test --filter ProgressMigrationTests/testLegacyMetadataValidation`

Expected: PASS.

- [x] **Step 12: Write and run a failing first-logical-event deduplication test**
...
- [x] **Step 13: Implement only first-logical-event filtering**
...
- [x] **Step 14: Run the duplicate-filter test**

Run: `swift test --filter ProgressMigrationTests/testFirstLegacyLogicalEventWins`

Expected: PASS.

- [x] **Step 15: Write and run failing canonical legacy-ID tests**
...
- [x] **Step 16: Implement only canonical legacy ID generation**
...
- [x] **Step 17: Run the canonical-ID tests**

Run: `swift test --filter ProgressMigrationTests/testCanonicalLegacyEventID`

Expected: both whole- and fractional-second ID cases PASS.

- [x] **Step 18: Write and run a failing legacy-to-course-event conversion test**
...
- [x] **Step 19: Implement only legacy-to-course-event conversion**

Use `legacyEventID(for:)` and decimal-string lesson local IDs. Copy timestamp,
kind, question ID, and correctness unchanged.

- [x] **Step 20: Run the event-conversion test**

Run: `swift test --filter ProgressMigrationTests/testLegacyEventConversion`

Expected: PASS.

- [x] **Step 21: Write and run failing v2 document-mapping and fractional-date tests**
...
- [x] **Step 22: Implement only v2 document mapping**
...
- [x] **Step 23: Run all v2 migration tests**
...
- [x] **Step 24: Write and run the failing current-v3 result test**
...
- [x] **Step 25: Decode current v3 using `ProgressDateCoding`**

Return `.current` only after the complete v3 document decodes with the exact
wire strategies from Task 4.

- [x] **Step 26: Run the current-v3 result test**

Run: `swift test --filter ProgressMigrationTests/testCurrentVersionThreeResult`

Expected: PASS.

- [x] **Step 27: Write and run the failing future-v4 envelope test**
...
- [x] **Step 28: Implement only the future-version envelope branch**

Return original bytes immediately when `version > 3`; never decode its payload.

- [x] **Step 29: Run the future-v4 envelope test**

Run: `swift test --filter ProgressMigrationTests/testFutureVersionSkipsPayloadDecode`

Expected: PASS.

- [x] **Step 30: Write and run failing corrupt-supported result tests**
...
- [x] **Step 1: Update the existing version-specific test expectations**
...
- [x] **Step 2: Add the initial store and decoder test helpers**
...
- [x] **Step 3: Add failing v2/v3 load and no-rewrite tests**
...
- [x] **Step 4: Run the focused store tests and confirm the keyed APIs are missing**
...
- [x] **Step 5: Implement only current/migrated load and keyed read queries**
...
- [x] **Step 6: Run the v2/v3 load and no-rewrite tests**
...
- [x] **Step 7: Write and run future/corrupt load-state tests**
...
- [x] **Step 8: Implement only future and corrupt load flags**
...
- [x] **Step 9: Run future/corrupt load-state tests**

Run: `swift test --filter ProgressStoreMigrationTests/testFutureAndCorruptLoadState`

Expected: PASS.

- [x] **Step 9a: Write and run a failing keyed-completion save test**
...
- [x] **Step 9b: Implement keyed completion and the basic v3 save path**
...
- [x] **Step 9c: Run the keyed-completion save test**

Run: `swift test --filter ProgressStoreMigrationTests/testKeyedCompletionWritesVersionThree`

Expected: PASS with the exact v3 wire document on disk.

- [x] **Step 10: Extend the helper, then write and run keyed stage tests**
...
- [x] **Step 11a: Add only event-ID injection**
...
- [x] **Step 11b: Add keyed stage methods and integer adapters**
...
- [x] **Step 12: Run keyed stage tests**

Run: `swift test --filter ProgressStoreMigrationTests/testKeyedStageMethods`

Expected: PASS.

- [x] **Step 13: Write and run presentation-state persistence tests**
...
- [x] **Step 14: Implement keyed presentation-state get/set methods**
...
- [x] **Step 15: Run presentation-state persistence tests**

Run: `swift test --filter ProgressStoreMigrationTests/testPresentationStatePersistence`

Expected: PASS.

- [x] **Step 16: Write and run attempt-ID and course-reset tests**
...
- [x] **Step 17: Implement `record(_:)` and course-only reset**
...
- [x] **Step 18: Run attempt/reset tests**

Run: `swift test --filter ProgressStoreMigrationTests/testAttemptIDAndCourseReset`

Expected: PASS.

- [x] **Step 18a: Write and run meaningful-activity/last-lesson tests**
...
- [x] **Step 18b: Implement meaningful activity and last-lesson updates**
...
- [x] **Step 18c: Run meaningful-activity tests**

Run: `swift test --filter ProgressStoreMigrationTests/testMeaningfulActivityAndLastLesson`

Expected: PASS, including reset and no-activity navigation boundaries.

- [x] **Step 19: Extend the helper, then write first-save and retry tests**
...
- [x] **Step 20a: Implement only writer injection**
...
- [x] **Step 20b: Implement retained save error and retry**
...
- [x] **Step 21: Run atomic write and retry tests**

Run: `swift test --filter ProgressStoreMigrationTests/testAtomicWriteAndRetry`

Expected: both missing-parent and retained-state retry tests PASS.

- [x] **Step 22: Write and run the complete future/corrupt mutation matrix**
...
- [x] **Step 23: Centralize the mutation guard across every write path**
...
- [x] **Step 24: Run store tests, full tests, and diff checks separately**
...
- [x] **Step 25: Commit the course-keyed store**
...
- [x] **Step 1: Write and run failing standalone presentation-model tests**
...
- [x] **Step 2: Implement visual-state and scene value types**
...
- [x] **Step 3: Implement only AI-code review value types**
...
- [x] **Step 4: Implement the presentation provenance and envelope**
...
- [x] **Step 5: Run standalone presentation tests**

Run: `swift test --filter LessonPresentationTests`

Expected: round-trip and schema tests PASS.

- [x] **Step 6: Add and run failing `Lesson` compatibility tests**
...
- [x] **Step 7: Add optional presentation decoding to `Lesson`**
...
- [x] **Step 10: Commit the presentation schema**
...
- [x] **Step 1: Write and run failing compatible-enrichment tests**
...
- [x] **Step 2: Add presentation-only field enrichment**
...
- [x] **Step 3: Run compatible and edited-lesson enrichment tests**

Run: `swift test --filter LessonStoreMigrationTests/testCompatibleBuiltInLessonReceivesOnlyStockPresentation`

Expected: matching lessons enrich and edited starter code remains untouched.

- [x] **Step 4: Write and run bundled presentation revision tests**
...
- [x] **Step 5: Implement bundled presentation provenance reconciliation**
...
- [x] **Step 6: Run presentation revision tests**
...
- [x] **Step 7: Write and run the future-presentation byte-preservation test**
...
- [x] **Step 8: Generalize the store's read-only content gate**
...
- [x] **Step 9: Run every lesson store and compatibility test**
...
- [x] **Step 10: Commit migration-safe presentation enrichment**
...
- [x] **Step 1a: Write and run failing identity/count validator tests**
...
- [x] **Step 1b: Implement only stable identity and scene-count validation**

Return `[PresentationValidationIssue]` rather than trapping. Add only the ID
and 3-through-6 scene rules from Step 1a.

- [x] **Step 1c: Run identity/count validator tests**

Run: `swift test --filter SwiftPilotPresentationContentTests/testValidatorRejectsInvalidIdentityOrSceneCount`

Expected: PASS with one named issue per invalid fixture.

- [x] **Step 2a: Write and run failing prose/state validator tests**
...
- [x] **Step 2b: Implement only required prose, state-change, and transcript rules**
...
- [x] **Step 2c: Run prose/state validator tests**

Run: `swift test --filter SwiftPilotPresentationContentTests/testValidatorRejectsInvalidProseOrState`

Expected: PASS.

- [x] **Step 3a: Write and run failing linked-activity validator tests**
...
- [x] **Step 3b: Implement only Recall-link and required pilot-exercise rules**
...
- [x] **Step 3c: Run linked-activity validator tests**

Run: `swift test --filter SwiftPilotPresentationContentTests/testValidatorRejectsInvalidLinkedActivity`

Expected: PASS.

- [x] **Step 4: Write and run failing focus-target validator tests**
...
- [x] **Step 5: Implement only focus-target validation**
...
- [x] **Step 6: Run the focus-target validator tests**

Run: `swift test --filter SwiftPilotPresentationContentTests/testValidatorRejectsInvalidFocusTargets`

Expected: PASS.

- [x] **Step 7: Write and run failing concept/objective mapping tests**
...
- [x] **Step 8: Implement release-aware mapping validation**
...
- [x] **Step 9: Run all validator rejection tests**
...
- [x] **Step 10: Define the exact scene map and AI-review claims**
...
- [x] **Step 11: Write and run the failing Lesson 1 exact-content test**
...
- [x] **Step 12a: Author the Lesson 1 poster and first two scenes**
...
- [x] **Step 12b: Author the Lesson 1 execution and output scenes**

Add `execution` and `output` with exact token/value/output IDs and static
descriptions from the Step 10 map.

- [x] **Step 12c: Add Lesson 1 transcript, mappings, and AI claims**
...
- [x] **Step 13: Run the Lesson 1 test**

Run: `swift test --filter SwiftPilotPresentationContentTests/testLessonOnePresentation`

Expected: PASS.

- [x] **Step 14: Write and run the failing Lesson 2 exact-content test**
...
- [x] **Step 16: Run the Lesson 2 test**

Run: `swift test --filter SwiftPilotPresentationContentTests/testLessonTwoPresentation`

Expected: PASS.

- [x] **Step 17: Write and run the failing Lesson 3 exact-content test**
...
- [x] **Step 18a: Author the Lesson 3 poster and binding scenes**

Add the poster, `var-binding`, and `first-value` scenes with reused narration.

- [x] **Step 18b: Author the Lesson 3 reassignment and output scenes**

Add `reassignment` and `output` with the exact `1` to `2` state change and
stdout `2`.

- [x] **Step 18c: Add Lesson 3 transcript, mappings, and AI claims**

Join narration, link Recall, add concept IDs with `objectiveMappings: []`, and
add the pinned `var`-versus-`let` claims.

- [x] **Step 19: Run the Lesson 3 test**

Run: `swift test --filter SwiftPilotPresentationContentTests/testLessonThreePresentation`

Expected: PASS.

- [x] **Step 20: Write and run the failing curriculum-scope test**
...
- [x] **Step 21: Wire only Lessons 1-3 into the default curriculum**
...
- [x] **Step 1: Write and run failing first-visit and return-entry tests**
...
- [x] **Step 2: Implement only the entry-mode resolver**
...
- [x] **Step 3: Run the entry-mode tests**

Run: `swift test --filter PresentationPlayerStateMachineTests/testEntryMode`

Expected: PASS.

- [x] **Step 4: Write and run failing Start/Next/Back transition tests**
...
- [x] **Step 5: Implement only Start, Next, and Back transitions**
...
- [x] **Step 6: Run Start/Next/Back transition tests**

Run: `swift test --filter PresentationPlayerStateMachineTests/testStartNextAndBackTransitions`

Expected: PASS.

- [x] **Step 7: Write and run failing Skip/Replay/Complete tests**
...
- [x] **Step 8: Implement only Skip, Replay, and Complete transitions**
...
- [x] **Step 9: Run all state-machine tests**
...
- [x] **Step 10: Commit the presentation state machine**
...
- [x] **Step 1: Write and run failing controller start/persistence tests**
...
- [x] **Step 2: Implement controller initialization and Start only**
...
- [x] **Step 3: Run the construction/Start test**

Run: `swift test --filter PresentationPlayerControllerTests/testConstructionDoesNotPersistAndStartDoes`

Expected: PASS.

- [x] **Step 4: Write and run failing scene-playback and cancellation tests**
...
- [x] **Step 5: Add the narration protocol and test adapter**
...
- [x] **Step 6: Implement Play/Pause and one cancellable scene task**
...
- [x] **Step 7: Implement Back/Next/Replay using cancel-before-transition order**
...
- [x] **Step 8: Run playback cancellation tests**

Run: `swift test --filter PresentationPlayerControllerTests/testPlaybackCancellationBoundary`

Expected: PASS with no stale advancement or duplicate write.

- [x] **Step 9: Write and run failing final-scene, Skip, and preference tests**
...
- [x] **Step 10: Implement final-scene, Skip, transcript, and preference controls**
...
- [x] **Step 11: Run all controller tests**
...
- [x] **Step 12: Write and run a failing bounded-layout hosting test**
...
- [x] **Step 12a: Write and run the failing rendered accessibility contract**
...
- [x] **Step 13: Implement code-execution and value-binding visuals**
...
- [x] **Step 14: Add output-flow animation and Reduce Motion fallback**
...
- [x] **Step 15: Add the static fallback for future visual kinds**
...
- [x] **Step 16: Implement poster and compact-summary chrome**
...
- [x] **Step 17: Implement active-scene controls and persistent caption**
...
- [x] **Step 18: Implement bounded transcript and static alternative**
...
- [x] **Step 19: Run the rendered accessibility contract green**
...
- [x] **Step 20: Run player layout and controller tests**
...
- [x] **Step 21: Commit the offline animated player**
...
- [x] **Step 1: Write and run failing pure evaluator tests**
...
- [x] **Step 2: Implement only the pure evaluator contract**
...
- [x] **Step 4: Write and run a failing bounded-layout test**
...
- [x] **Step 4a: Write and run the failing AI-view accessibility test**
...
- [x] **Step 5a: Implement prompt, code, and answer controls**
...
- [x] **Step 5b: Implement submission feedback and Retry**
...
- [x] **Step 5c: Add keyboard and VoiceOver semantics**
...
- [x] **Step 6: Run view and evaluator tests**
...
- [x] **Step 7: Commit the offline AI-code exercise**
...
- [x] **Step 1a: Run the root-route test red**
...
- [x] **Step 2a: Isolate `AppSettings` persistence for tests**
...
- [x] **Step 2b: Add injectable model stores and root route**
...
- [x] **Step 3: Run the root-route test**

Run: `swift test --filter AppModelNavigationTests/testEveryNewModelStartsAtCourseHomeWithoutMutation`

Expected: PASS.

- [x] **Step 4: Write failing open-course destination tests**
...
- [x] **Step 4a: Run the open-course test red**
...
- [x] **Step 5: Implement Swift course entry and unavailable-course handling**
...
- [x] **Step 6: Run open-course tests**

Run: `swift test --filter AppModelNavigationTests/testOpenCourseUsesDeterministicDestination`

Expected: all Start/Continue/Review and Coming next paths PASS.

- [x] **Step 6a: Write workspace-persistence outcome tests**
...
- [x] **Step 6a.1: Run the workspace-persistence test red**
...
- [x] **Step 6b: Implement the explicit persisted-workspace outcome**
...
- [x] **Step 6c: Run the workspace-persistence outcome test**

Run: `swift test --filter CancellableProcessRunnerTests/testSwiftRunnerReportsWorkspacePersistenceSeparatelyFromExecution`

Expected: PASS for saved-invalid-code and failed-write cases.

- [x] **Step 6d: Write a real child-process cancellation test**
...
- [x] **Step 6d.1: Run the child-process test red**
...
- [x] **Step 6e.1: Implement race-free POSIX process-group launch**
...
- [x] **Step 6e.2: Add process-group cancellation**
...
- [x] **Step 6f.1: Route Swift execution through the cancellable runner**
...
- [x] **Step 6f.2: Route CLI AI through the cancellable runner**
...
- [x] **Step 6f.3: Inject and own AppModel async operations**
...
- [x] **Step 7a: Run the cancellation/Home test red**
...
- [x] **Step 8a: Centralize task cancellation and stale-result suppression**
...
- [x] **Step 8b: Add the workspace cancellation registration API**
...
- [x] **Step 12: Run course-card tests**

Run: `swift test --filter CourseHomeCardModelTests`

Expected: all availability and evidence-boundary tests PASS.

- [x] **Step 13: Commit routing models**
...
- [x] **Step 1: Write failing root-identity layout tests**
...
- [x] **Step 1a: Run root-identity tests red**
...
- [x] **Step 2: Implement the Course Home card grid**
...
- [x] **Step 3: Implement the course workspace shell and Home action**
...
- [x] **Step 4: Route `ContentView` between separate identities**
...
- [x] **Step 1: Write failing one-shot scroll-request tests**
...
- [x] **Step 4: Write failing bounded-workspace hosting tests**
...
- [x] **Step 4a: Run bounded-workspace tests red**
...
- [x] **Step 5: Convert the sidebar to `LessonKey` identity**
...
- [x] **Step 6a: Add the bounded learning scroll**
...
- [x] **Step 6b: Add fresh detail identity and top-anchor consumption**
...
- [x] **Step 7.1: Bound the wide workspace split**
...
- [x] **Step 7.2: Bound the narrow workspace panel**
...
- [x] **Step 7a: Write the interactive scroll regression**
...
- [x] **Step 7a.1: Run the interactive scroll regression red**
...
- [x] **Step 7b: Wire viewport probes and satisfy the interaction contract**
...
- [x] **Step 1: Write failing first-surface/legacy policy tests**
...
- [x] **Step 1a: Run first-surface policy tests red**
...
- [x] **Step 2a: Add a reference-type workspace session**
...
- [x] **Step 2b: Register the whole workspace cancellation boundary**
...
- [x] **Step 2a: Embed the owned player directly below navigation/status**
...
- [x] **Step 3: Remove automatic Deep Lesson presentation**
...
- [x] **Step 4: Run first-surface policy tests**

Run: `swift test --filter LessonLearningLoopTests/testInitialLessonSurfacePolicy`

Expected: all first/return/legacy/custom surface cases PASS.

- [x] **Step 5: Write failing Recall handoff tests**
...
- [x] **Step 5a: Run Recall handoff tests red**
...
- [x] **Step 6a: Implement the reusable Recall view**
...
- [x] **Step 6b: Replace Deep Lesson's private Recall rendering**
...
- [x] **Step 8: Run Recall handoff tests**
...
- [x] **Step 9: Write failing AI-attempt integration tests**
...
- [x] **Step 9a: Run AI-attempt tests red**
...
- [x] **Step 10a: Embed the pilot AI review without side effects on open**
...
- [x] **Step 10b: Construct complete deterministic assessment attempts**
...
- [x] **Step 10c: Persist one retained attempt per Submit**
...
- [x] **Step 11: Run AI-attempt integration tests**

Run: `swift test --filter LessonLearningLoopTests/testAICodeReviewRecordsOnlySubmittedAttempts`

Expected: PASS.

- [x] **Step 12: Update the compact learning-path stepper**
...
- [x] **Step 1: Write failing beginner-onboarding copy tests**
...
- [x] **Step 1a: Run onboarding tests red**
...
- [x] **Step 2a: Update beginner welcome copy**
...
- [x] **Step 2b: Bound the Welcome layout at minimum window size**
...
- [x] **Step 4: Write failing corrupt/save-error action tests**
...
- [x] **Step 4a: Run local-error action tests red**
...
- [x] **Step 5c: Wire Retry and injected Reveal File actions**
...
- [x] **Step 1: Write and run the failing offline-core contract test**
...
- [x] **Step 2: Make only the bundled core satisfy the offline contract**
...
- [x] **Step 3: Run the offline-core and full suites**
...
- [x] **Step 4: Write the failing bundle-verifier shell checks**
...
- [x] **Step 5: Implement deterministic bundle verification**
...
- [x] **Step 6: Build and verify the release bundle**
...
- [x] **Step 7a: Implement guarded smoke-state commands and literal fixtures**
...
- [x] **Step 8: Validate CI syntax and local commands**
...
- [x] **Step 9: Commit automated release gates**
...
- [x] **Step 1: Record the pre-smoke evidence and quit the app**
...
- [x] **Step 2: Back up all real learner state before fixture tests**
...
- [x] **Step 2a: Install a truly clean disposable state**
...
- [x] **Step 3: Verify clean first launch and Course Home**
...
- [x] **Step 4: Verify the real animated Lesson 1-3 loop offline**
...
- [x] **Step 5: Reproduce the original scroll regression path**
...
- [x] **Step 6: Verify migration and byte-preservation fixtures**
...
- [x] **Step 7: Restore the original learner state even after a failed smoke**
...
- [x] **Step 8: Relaunch the restored real app once**
...
- [x] **Step 9: Commit the completed smoke evidence**
...
**Milestone 1 evidence:** The backed-up real-app result is recorded in
[`docs/testing/course-platform-milestone-1-smoke.md`](../../testing/course-platform-milestone-1-smoke.md).
Tasks 1-19 are represented by their focused commits and the migration,
accessibility, layout, forward-compatibility, and restored-state evidence linked
there. The user-approved player-first follow-up is specified and tracked in
[`2026-07-12-player-first-lesson-flow.md`](2026-07-12-player-first-lesson-flow.md).
Its protected native proof confirms one 16:9 player first, free outer scrolling
during narration, no editor locking or focus theft, and exact state restoration.
The current smoke report records the latest verified bundle commit and hashes;
the final documentation commit is rebuilt and verified again before merge.

- [x] **Step 1: Update user-facing shipped behavior only after smoke passes**
...
- [x] **Step 2: Mark this plan's completed checkboxes and evidence links**
...
- [x] **Step 3: Run the final pre-review gate**
